...
export const FeedbackVideo = async () => {
  ...
  return (
    <section className="px-6 md:px-16 lg:px-20 3xl:px-40 py-16 md:py-24 3xl:py-48">
      ...
      <div className="mt-12 md:mt-16 3xl:mt-28 border border-black/10 rounded-xl 3xl:rounded-3xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 divide-y md:divide-y-0 lg:divide-x divide-black/10">
