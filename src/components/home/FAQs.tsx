...
function FAQs() {
  return (
      ...
      <div className="flex flex-col 3xl:flex-row 3xl:items-center gap-10 md:gap-14 3xl:gap-[5vw]">
        {/* Centred above the questions; left-aligned beside them from 3xl. */}
        <div className="text-center 3xl:text-left 3xl:w-[30%] 3xl:shrink-0">
          <h2 className={`${HEADING} leading-[1.15]`}>
            Everything you need to{" "}
            <span className="font-bold text-[#4a5f66]">know.</span>
          </h2>
          <p className={`${SMALL} text-[#4a5f66] tracking-[0.25em] uppercase mt-4 md:mt-5 3xl:mt-[1.4vw]`}>
